...
class VisionTestCli : NoOpCliktCommand(name = "visiontest") {
    ...
    init {
        ...
        subcommands(
            ...
            PressKeyCommand(lazy { components }),
            ClearTextCommand(lazy { components }),
            LongPressCommand(lazy { components }),
            DoubleTapCommand(lazy { components }),
            DismissKeyboardCommand(lazy { components }),
            HandleAlertCommand(lazy { components }),
